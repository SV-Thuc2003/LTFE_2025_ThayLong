      ...
      <div className="mb-8">
        <table className="w-full border-collapse">
          ...
          <tr>
            ...
            <th className="text-left py-2 border-b border-[#a48c8ca8] w-[900px]"></th>
            <th className="py-2 border-b border-[#a48c8ca8] w-[400px] uppercase text-base font-bold text-center">
              {('Sản phẩm')}
            </th>
          ...
          <tfoot>
          <tr>
            <td colSpan={6} className="py-2 border-b border-[#a48c8ca8]">
