...
const Checkout: React.FC = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`/api/cart/${userId}`, {
            ...
            .catch(err => console.error(("checkout.fetchCartError"), err));
    }, []);
    ...
    const handleApplyDiscountCode = () => {
        console.log(("checkout.discountApplied"), checkoutState.discountCode);
    };
    ...
    const handlePlaceOrder = async () => {
        ...
        if (checkoutState.paymentMethod === "vnpay") {
            try {
                ...
                console.error(("checkout.qrError"), err);
            }
        } else {
            try {
                const payload = {
                ...
                console.error(("checkout.orderError"), err);
            }
        }
    };
